      ...
      child: Column(
        ...
        children: [
          ...
          _buildContactItem(
            ...
            subtitle: '+77769400202',
            onTap: () => _launchUrl('tel:+77769400202'),
          ),
          const Divider(height: 24),
          _buildContactItem(
            icon: Icons.email_outlined,
            title: 'Email',
            subtitle: 'goodjob.kz07@gmail.com',
            onTap: () => _launchUrl('mailto:goodjob.kz07@gmail.com'),
          ),
          const Divider(height: 24),
          _buildContactItem(
            ...
            onTap: () => _launchUrl('https://wa.me/77474960138'),
          ),
        ],
      ),
    );
